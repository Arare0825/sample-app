...
<form id="edit" method="post" action="{{ route('todo.update', ['id'=>$todays->id]) }}">
@csrf
    <label for="exampleInputtext">タスク名</label>
    <input type="text" name="title" class="form-control" id="text" placeholder="タスクを入力して下さい" value="{{ $todays->title }}">
  </div>
