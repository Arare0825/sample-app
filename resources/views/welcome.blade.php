        ...
        <div class="relative flex items-top justify-center min-h-screen  sm:items-center sm:pt-0">
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="text-sm text-gray-700 underline">ユーザー情報</a>
                    @else
                        <a href="{{ route('login') }}" class="text-sm text-gray-700 underline">ログイン</a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-700 underline">新規作成</a>
                        @endif
                    @endauth
                </div>
            @endif
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="title flex justify-center pt-8 sm:justify-start sm:pt-0">
                <h1>Todo List</h1>
                </div>
